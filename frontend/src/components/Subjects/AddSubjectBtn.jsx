...
function AddSubjectBtn({ onClose }) {
  ...
  return (
    <button
      ...
      className=" group flex mt-4 ps-3 pe-7 pt-3 pb-3 rounded-2xl bg-zinc-600 hover:bg-zinc-300 hover:text-zinc-800 cursor-pointer w-full"
    >
